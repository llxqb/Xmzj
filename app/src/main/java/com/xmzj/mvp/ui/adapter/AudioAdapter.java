 ...
 * 音频列表adapter
 */
public class AudioAdapter extends BaseQuickAdapter<AudioListResponse.DataBean, BaseViewHolder> {

    private Context mContext;

    public AudioAdapter(Context context, @Nullable List<AudioListResponse.DataBean> data) {
